...
public class Magpie3
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "all star") >= 0)
        {
                ...
                || findKeyword(statement,"turtle") >= 0)
        {
            response = "Tell me more about your pets.";
                ...
                || findKeyword(statement,"Mr. Malloy") >= 0)
        {
        ...
        else if (findKeyword(statement,"Darth Plagueis the Wise") >= 0)
        {
        ...
        else if (findKeyword(statement,"Is it possible to learn this power") >= 0)
        {
