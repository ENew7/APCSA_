...
public class Picture extends SimplePicture 
{
    ...
    {
        Picture doof = new Picture("Doofenshmirtz_Portrait.jpg");
        Picture mario = new Picture("Paper_Mario.jpg");
        Picture s = new Picture("spaget.jpg");
         Picture doofOnlyGreen = new Picture(doof);
        doofOnlyGreen.keepOnlyGreen();
        this.copy(doofOnlyGreen,0,0);
        this.copy(doof,0,100);
        this.mirrorHorizontal();
        Picture marioNoRed = new Picture(mario);
        marioNoRed.zeroRed();
        this.copy(marioNoRed,300,0);
        this.copy(doof,400,0);
        this.copy(mario,500,0);
        this.mirrorVertical();
        Picture sOnlyBlue = new Picture(s);
        sOnlyBlue.keepOnlyBlue();
        this.copy(s,0,100);
